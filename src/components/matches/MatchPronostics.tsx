        ...
        <div className="p-3 sm:p-5">
          <div className="flex justify-center items-center gap-2 sm:gap-4 relative">
            <div className="flex flex-col items-center gap-1 sm:gap-2">
              <button className={`w-12 h-12 sm:w-16 sm:h-16 rounded-full border-2 flex items-center justify-center transition-all ${prono.freePrediction.choice === 'home' ? 'border-brand-green bg-brand-green/10 ring-2 sm:ring-4 ring-brand-green/20' : 'border-slate-100 dark:border-brand-slate hover:border-brand-green/50'}`}>
            ...
            <div className="flex flex-col items-center gap-1 sm:gap-2">
              <button className={`w-10 h-10 sm:w-12 sm:h-12 rounded-full border-2 flex items-center justify-center font-bold text-slate-400 transition-all ${prono.freePrediction.choice === 'draw' ? 'border-brand-green bg-brand-green/10 text-brand-green ring-2 sm:ring-4 ring-brand-green/20' : 'border-slate-100 dark:border-brand-slate hover:border-brand-green/50'}`}>
                X
              </button>
            ...
            <div className="flex flex-col items-center gap-1 sm:gap-2">
              <button className={`w-12 h-12 sm:w-16 sm:h-16 rounded-full border-2 flex items-center justify-center transition-all ${prono.freePrediction.choice === 'away' ? 'border-brand-green bg-brand-green/10 ring-2 sm:ring-4 ring-brand-green/20' : 'border-slate-100 dark:border-brand-slate hover:border-brand-green/50'}`}>
