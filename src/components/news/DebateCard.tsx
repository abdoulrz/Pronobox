          ...
          <div className="flex items-center gap-1.5 flex-wrap">
            ...
            {debate.sourceArticle && (
              <span className="text-[10px] bg-blue-500/10 text-blue-400 px-1.5 py-0.5 rounded-full font-medium">
                📰 {debate.sourceArticle.source}
              </span>
            )}
            {debate.isAutoGenerated && (
              <span className="text-[10px] bg-purple-500/10 text-purple-400 px-1.5 py-0.5 rounded-full font-medium">
                Auto
              </span>
            )}
            {debate.isFavorite && (
              <span className="text-[10px]" title="Sauvegardé">⭐</span>
            )}
          </div>
